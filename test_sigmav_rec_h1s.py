...
def main_test_sigmav_rec_h1s():
    """
    Generates and plots reaction rates <sigma v> for
    e + H+ -> H(1s) + hν over a range of Te.
    """
    ...
    ax.text(0.15, 0.90,
            ...
            fontsize=9)
    ax.text(0.15, 0.87,
            'Data from Janev et al., "Elementary Processes in Hydrogen-Helium Plasmas", p 32.',
            transform=ax.transAxes,
            fontsize=9)
