...
def main_test_sigmav_ion_h0():
    ...
    # Titles and labels
    ax.set_title(r'e + H(1s) $\rightarrow$ e + H$^+$ + e')
    ax.set_xlabel('Te (eV)')
    ...
    ax.text(0.15, 0.90,
            ...
            fontsize=9)
    ax.text(0.15, 0.87,
            'Data from Janev et al., "Elementary Processes in Hydrogen-Helium Plasmas", p 258.',
            transform=ax.transAxes,
            fontsize=9)
