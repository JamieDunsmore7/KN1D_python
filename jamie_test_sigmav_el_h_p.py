...
# translated from plot_sigmav_EL_H_P.pro

import numpy as np
import matplotlib.pyplot as plt
from sigmav_el_h_p import SigmaV_EL_H_P
...
for i, e0 in enumerate(e0s):
    ...
    sigv = SigmaV_EL_H_P(Ti, E)     # returns m^3/s
    sigv *= 1e6                     # convert to cm^3/s

    ax.plot(Ti, sigv, color=colors[i], linewidth=3, 
            label=f'E0 = {e0:.0g} eV')
# 5) Add legend
