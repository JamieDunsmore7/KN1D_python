...
def main_test_sigmav_h1s_hn_hp():
    ...
    # Titles and labels
    ax.set_title(r'e + H$_2^+$ $\rightarrow$ e + H(1s) + H(n>1)')
    ax.set_xlabel('Te (eV)')
