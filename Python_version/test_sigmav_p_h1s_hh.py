...
def main_test_sigmav_p_h1s_hh():
    ...
    # Titles and labels
    ax.set_title(r'e + H$_2^+$(v) $\rightarrow$ e + H$^+$ + H(1s)')
    ax.set_xlabel('Te (eV)')
