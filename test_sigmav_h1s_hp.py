...
def main_test_sigmav_p_h1s_hp():
    """
    Generates and plots reaction rates <sigma v> for
    e + H2+ -> e + H+ + H(1s) over a range of Te,
    returning also E0_min, E0_max, and E0_ave.
    """
    ...
    # Titles and labels
    ax.set_title(r'e + H$_2^+$ $\rightarrow$ e + H$^+$ + H(1s)')
    ax.set_xlabel('Te (eV)')
